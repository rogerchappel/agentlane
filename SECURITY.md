...
Replace this section with the supported versions for `agentlane`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `agentlane` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in agentlane.
